...
const depositAddress = "TMMzvF6P8n12Yw3sN6L9H4QxE6dP9a2c3";
...
export default function PersonalCenter() {
  ...
  const [copied, setCopied] = useState<null | "deposit" | "referral">(null);
  ...
  const handleCopy = (value: string, key: "deposit" | "referral") => {
          ...
          <div className="px-4 py-6 md:px-8 md:py-8">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_1fr] gap-6 animate-fade-in">
                <div className="rounded-2xl border border-[#232736] bg-[#121622] p-6">
                  ...
                  <p className="mt-1 text-sm text-[#8d9096]">
                    Choose a network and transfer funds to the address below.
                  </p>
                  ...
                  <div className="mt-6 space-y-4">
                    ...
                    <button
                      type="button"
                      className="w-full rounded-full bg-[#183025] px-4 py-3 text-sm font-semibold text-[#4ade80] shadow-[0_8px_24px_rgba(74,222,128,0.2)] transition hover:-translate-y-0.5"
                    >
                      I have transferred
                    </button>
                  </div>
                ...
                <div className="rounded-2xl border border-[#232736] bg-[#121622] p-6">
                  ...
                  <div className="mt-6 space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        <p className="text-sm text-[#8d9096]">Network</p>
                        <select className="mt-2 w-full rounded-xl border border-[#232736] bg-[#0c0f16] px-4 py-3 text-sm text-[#f5f6f7] outline-none focus:border-[#f5c245]">
                          <option>TRC20</option>
                          <option>ERC20</option>
                          <option>BEP20</option>
                        </select>
                    ...
                    <button
                      type="button"
                      className="w-full rounded-full bg-[#2f1b1d] px-4 py-3 text-sm font-semibold text-[#f87171] shadow-[0_8px_24px_rgba(248,113,113,0.2)] transition hover:-translate-y-0.5"
                    >
                      Submit Withdrawal
                    </button>
                  </div>
            ...
            {activeTab === "history" && (
              <div className="space-y-4 animate-fade-in">
                <div className="hidden md:grid grid-cols-4 gap-4 px-4 text-xs uppercase tracking-[0.2em] text-[#6f757e]">
                  <span>Type</span>
                  <span>Amount</span>
                  <span>Status</span>
                  <span>Time</span>
