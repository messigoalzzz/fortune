...
const generalTerms: Array<string | JSX.Element> = [
  "Players must be of legal gambling age (18 or older) in his or her jurisdiction in order to play at FortuneX.",
  "FortuneX reserves the right to exclude anybody from participating in promotions and receiving newsletters, and can void or reject any transactions upon their discretion.",
  "It is the player's sole responsibility to safeguard their login credentials (email & password) at all times, and FortuneX will not be held responsible for any unauthorized use of a player's account.",
  "FortuneX games are for players' personal entertainment, and players acknowledge that gambling in general may result in monetary losses. Players, therefore, consent that FortuneX cannot be held responsible for losses or damages of any kind resulting from real money play. All wagered transactions are final and non-refundable.",
  <>
    ...
    by FortuneX and winnings paid at the casino&apos;s discretion. In case of any discrepancy between the game
    results on a player&apos;s device and the results on FortuneX servers, the results on FortuneX&apos; servers
    will be considered final and binding. Upon request, records can be readily provided in order to support the case.
  </>,
  "Players will not use FortuneX for any unlawful or fraudulent activity, nor for prohibited transactions under the laws of any jurisdiction applying to the player. This includes, but is not limited to, money laundering and using FortuneX as a cryptocurrency mixer. If FortuneX suspects that a player is engaging in fraudulent activity, or is funding their account through unlawful means, their account may be blocked immediately and any funds tied to their account withheld.",
  "Malfunctions void all pays and plays. FortuneX accepts no liability for omissions, errors, software bugs, service interruption, or service termination.",
  "The player agrees to receive administrative and promotional emails from FortuneX or other Slotland Entertainment projects. To stop receiving promotional emails, players must unsubscribe from receiving such emails in their account profile or may contact our Customer Support team.",
  "FortuneX is entitled to collect, store, and process only the personal data provided by players. This will only be used for the purposes of i) proof of agreement to terms, ii) sending any relevant promotional material or information about FortuneX and player's account, iii) further agreements between player and Slotland Entertainment, iv) fulfilling any legal obligations as a result of these terms, v) protecting FortuneX in any judicial, administrative, or other proceedings.",
  <>
    FortuneX will never sell your data to third parties and your data will not be provided to third parties unless
    required by law. Further information about data use can be found in FortuneX&apos;{" "}
    <a className="text-primary underline" href="/privacy-policy">
      Privacy Policy
    </a>
    .
  </>,
  "FortuneX utilizes cookies to track player visits for the purpose of personalizing player gaming experience. This information is collected to improve overall services and not in a way which personally identifies players. Players can turn off cookies at any time, by following instructions on their browsers.",
  "Duplication, redistribution, or publication of any content or part of FortuneX is strictly prohibited unless used to promote FortuneX directly.",
  <>
  ...
  "All funds credited prior to 100% deposit confirmation are a courtesy of FortuneX and all wins resulting from said deposit(s) will belong to the casino until the deposit status will read \"Confirmed\" in the Cashier. In the event of failed deposit(s), subsequent withdrawals will be voided and your account will be subject to suspension/cancelation. Withdrawals can only be requested when all deposits are in the \"Confirmed\" state.",
  "All withdrawals will be subject to an internal audit before being processed. FortuneX reserves all rights to void any winnings for failed audits. If it appears that the player is participating in malicious practices, is taking advantage of any software or system bug/failure, or is participating in any form of activity that FortuneX deems to be abusive, FortuneX, at its sole discretion, reserves the right to confiscate winnings and/or deposit of such abuse from the player in question.",
  ...
  "Players understand that digital currencies can fluctuate in value and that FortuneX exchange rates update every 15 minutes.",
  "Throughout the lifetime of a player's account, FortuneX reserves the right to use verification procedures to verify the player's identity, and access to a player's account may be suspended or closed if FortuneX determines that a player has supplied false or misleading information.",
  "Jackpot Trigger can only be played using Jackpot Tokens and not from funds in your cash balance. These tokens are earned through playing other FortuneX games and cannot be purchased. Every time a player's winnings accumulate to a multiple of $100, one Jackpot Token is earned. This excludes all Jackpot Trigger winnings.",
  ...
  "Terms and conditions may be changed without prior notice. It is the player's responsibility to make sure that they are up to date with recent changes to the terms and conditions, and their continued use of FortuneX will be deemed as acceptance and consent to all updates.",
];
...
const bonusTerms: Array<string | JSX.Element> = [
  ...
  <>
    ...
    game. Jackpot Tokens are earned solely through playing other FortuneX games (see{" "}
    <a className="text-primary underline" href="/terms-and-conditions">
      General Terms &amp; Conditions
    </a>
    ).
  </>,
  "FortuneX reserves the right to deny or remove any bonus or withdrawal if the player owns or has previously owned another FortuneX account. Bonuses may also be denied to players who exhibit suspected fraudulent behavior.",
  "FortuneX also reserves the right to exclude players from bonuses if the player has been found to abuse bonuses and promotional offers. This includes but is not solely applicable to players who open multiple accounts and players who do not have active depositing accounts, or players who continuously refuse to meet the set bonus terms.",
  "FortuneX reserves the right to modify or cancel a promotional offer and modify bonus terms at any time without prior notice. It is the responsibility of all players to check bonus terms and promotional offers prior to acting upon them.",
...
function TermsAndConditionsPage() {
  ...
  return (
    <div className="space-y-8 [&_p]:text-base [&_p]:leading-7">
      ...
      <p className="!text-sm">
        FortuneX is operated by Slotland Entertainment S.A., with registered address at Bonovo Road, Fomboni, Island
