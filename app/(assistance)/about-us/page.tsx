function AboutUsPage() {
  return (
    <div className="space-y-8 [&_p]:text-base [&_p]:leading-7">
      <h1 className="bg-image-clip-text text-[2.5rem] mb-[30px]">About Us</h1>
      ...
      <p>
        You are promised maximum security with minimum complications. Our experienced team has created an exciting
        environment where the rewards are sky-high. We provide safety and fun, and endorse responsible gaming at all
        levels, along with dedicated customer service. Explore games found at no other casino and become a
