  ...
  return (
    <div className="space-y-8 [&_p]:text-base [&_p]:leading-7">
      ...
      <p className="text-center font-bold">
        We request minimal personal data, only that which is essential to protecting your account and assisting your
        gaming.
      </p>
      ...
      <p>
        We never sell personal data and we carry out all processing operations in strict compliance with the EU General
      ...
      <p className="text-center font-bold">
        Your data will not be stored any longer than is necessary to provide you with our services.
      </p>

      <h2 className="text-[2rem] leading-none">Your Rights</h2>
      <p>
        You can at any time unsubscribe from all emails, and request to have your account deleted and all data
        permanently removed.
      </p>
      <p>
        You will be notified of any changes to the processing and disclosure of your data, in the event that your
        consent was required. Please check this Privacy Policy regularly, as it may be modified in keeping with standard
        privacy laws.
      </p>
      <p>
        You can contact us if you have queries regarding our policy, to obtain a copy of your personal details on
        record, or to update/correct data.
      </p>
    </div>
  );
}
